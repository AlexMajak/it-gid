...
function f4() {
	let i = document.querySelector('.i-4').checked;
...
function f6() {
	...
	document.querySelector('.out-6').textContent = i.value;
}
...
function f7() {
	...
	document.querySelector('.out-71').textContent = i;
...
function f9() {
	let r = document.querySelector('.r-9').checked;
	let out = document.querySelector('.out-9');
	if (r == true) {
		out.textContent = document.querySelector('.r-9').value;
	} else {
		out.textContent = ('false');
	}
}
...
function f10() {
	...
	document.querySelector('.out-10').style.backgroundColor = i;
}
...
function f11() {
	let i1 = document.querySelector('.i-111').value;
	document.querySelector('.i-112').value = i1;
}
...
function f13() {
	let i = document.querySelector('.i-13').value;
	document.querySelector('.out-13').textContent = i;
	console.log(i);
...
function f15() {
	...
	document.querySelector('.t-15').textContent = i;
}
...
function f16() {
	...
	document.querySelector('.out-16').textContent = s;
...
function f17() {
	...
	document.querySelector('.out-17').textContent = s;
}
