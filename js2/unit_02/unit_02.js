...
function t12() {
	let firstNameIn = document.querySelector('.i-12-1').value;
	let lastNameIn = document.querySelector('.i-12-2').value;
	let div = document.querySelector('.out-12');
	div.textContent = ("Hello" + " " + firstNameIn + " " + lastNameIn);
}
...
function t16() {
	let numOne = document.querySelector('.i-16-1').value;
	let numTwo = document.querySelector('.i-16-2').value;
	document.querySelector('.out-16').textContent = numOne + numTwo;
}
...
function t19() {
	...
	let b = document.querySelector('.i-19-1').value;
