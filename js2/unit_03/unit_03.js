...
function f4() {
	let i = 2023 - +document.querySelector('.i-4').value;
...
function f13() {
	let i = document.querySelector('.i-130').value;
	document.querySelector('.out-13').textContent = (typeof i);
}
